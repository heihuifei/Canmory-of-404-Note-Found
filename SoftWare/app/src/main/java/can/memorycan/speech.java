...
import com.example.baiduspeechdialog.dialog.SpeechLongBottomSheetDialog;
...
public class speech extends AppCompatActivity {
    ...
    private void initEvents() {
        mOpenSpeechDialogBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //打开百度语音对话框
                SpeechBottomSheetDialog speechBottomSheetDialog = SpeechBottomSheetDialog.getInstance(speech.this);
        ...
        mOpenSpeechLongDialogBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //打开百度语音对话框
                SpeechLongBottomSheetDialog speechLongBottomSheetDialog = SpeechLongBottomSheetDialog.getInstance(speech.this);
    ...
    private void onePermission(){
        RxPermissions rxPermissions = new RxPermissions(speech.this); // where this is an Activity instance
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean granted) throws Exception {
                        ...
                        if (granted) { // 在android 6.0之前会默认返回true
                            ...
                            // 未获取权限
                            Toast.makeText(speech.this, "您没有授权该权限，请在设置中打开授权", Toast.LENGTH_SHORT).show();
                        }
                    }
