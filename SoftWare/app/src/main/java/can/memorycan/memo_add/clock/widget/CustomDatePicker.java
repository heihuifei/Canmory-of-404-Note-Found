package can.memorycan.memo_add.clock.widget;
...
public class CustomDatePicker {
    ...
    private can.memorycan.memo_add.clock.widget.DatePickerView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new can.memorycan.memo_add.clock.widget.DatePickerView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new can.memorycan.memo_add.clock.widget.DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new can.memorycan.memo_add.clock.widget.DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new can.memorycan.memo_add.clock.widget.DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new can.memorycan.memo_add.clock.widget.DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
