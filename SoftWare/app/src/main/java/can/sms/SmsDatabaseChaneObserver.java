...
public class SmsDatabaseChaneObserver extends ContentObserver {
    ...
    private int needDeliverySMS;

    public SmsDatabaseChaneObserver(ContentResolver resolver, Handler mHandler) {
        super(mHandler);
        mResolver = resolver;
    ...
    private int setArrayList(String strbody) {
        ...
        int isDeliverySMS = mSMSMatch.getIsDeliverySMS();

        setParam();

        if (needDeliverySMS != 0) {
...
//                System.out.println(arrayList.get(1));
    ...
    private void setParam() {
        ...
        needDeliverySMS=mgr.getParcel_on(1);
    }
